...
cSCIntro::cSCIntro(cocos2d::Size size, cBaseMode * thisMode)
{
	...
	cocos2d::Sprite *logo_3 = cocos2d::Sprite::create("gameTypes/calend.png");
	...
	cocos2d::Size szLogoSmall = { visibleSize.width / 9.0f, visibleSize.width / 9.0f };
	{
		...
		cocos2d::Sprite *logoImage = cocos2d::Sprite::create("gameTypes/calend.png");
	...
	cocos2d::Size szLogoTitle = { szIBG.width - szLogoSmall.width - indent * 3.0f, szLogoSmall.height };
	{
		...
		cocos2d::Label* exam = cocos2d::Label::createWithTTF(*gTtfConfig, u8"Кружок", cocos2d::TextHAlignment::CENTER);
