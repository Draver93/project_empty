...
cVWIntro::cVWIntro(cocos2d::Size size, cBaseMode *thisMode)
{
	...
	logo_3->setColor(cocos2d::Color3B(255, 255, 100));
	...
	cocos2d::Size szLogoSmall = { visibleSize.width / 9.0f, visibleSize.width / 9.0f };
	{
		...
		logoImage->setColor(cocos2d::Color3B(255, 255, 100));
		setNodeInRect(logoImage, szLogoSmall, szLogoSmall.width * 0.2f);
		logoImage->setOpacity(200);
