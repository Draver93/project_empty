...
cTWIntro::cTWIntro(cocos2d::Size size, cBaseMode *thisMode)
{
	...
	cocos2d::Size szLogoTitle = { szIBG.width - szLogoSmall.width - indent * 3.0f, szLogoSmall.height };
	{
		...
		cocos2d::Label* exam = cocos2d::Label::createWithTTF(*gTtfConfig, u8"Тест", cocos2d::TextHAlignment::CENTER);
