...
cTIntro::cTIntro(cocos2d::Size size, cBaseMode * thisMode)
{
	...
	cocos2d::Sprite *logo_3 = cocos2d::Sprite::create("gameTypes/book.png");
	...
	cocos2d::Size szLogoSmall = { visibleSize.width / 9.0f, visibleSize.width / 9.0f };
	{
		...
		cocos2d::Sprite *logoImage = cocos2d::Sprite::create("gameTypes/book.png");
